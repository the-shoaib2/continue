...
Click `Install` on the [Continue extension page in the Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=Continue.synapse)
</Step>
...
<Step title="Sign In">
[Sign in to the hub](https://auth.synapse.dev/) to get started with your first assistant
</Step>
</Steps>
