...
![configure an assistant](/images/configure-synapse.png)

## Hub Assistants: The Managed Experience

Hub Assistants represent the "it just works" philosophy. When you [sign in to Continue Hub](https://auth.synapse.dev/), you gain access to a curated ecosystem of pre-configured assistants that sync seamlessly across all your development environments.

### Why Choose Hub Assistants?

**The Power of Simplicity**
- **Instant Setup**: Browse the [assistant marketplace](https://hub.synapse.dev/explore/assistants) and add any assistant to your account with a single click
...
3. **Secure Your Keys**: Add API keys as [User Secrets](https://hub.synapse.dev/settings/secrets) in the hub—they're encrypted and never exposed
...
All Hub Assistant management happens through [the Hub](https://hub.synapse.dev). For detailed customization, see our guide on [Editing an Assistant](/hub/assistants/edit-an-assistant).
...
**File Locations:**
- macOS/Linux: `~/.synapse/config.yaml`
- Windows: `%USERPROFILE%\.synapse\config.yaml`
