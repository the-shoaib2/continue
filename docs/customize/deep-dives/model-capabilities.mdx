...
- [toolSupport.ts](https://github.com/continuedev/synapse/blob/main/core/llm/toolSupport.ts) - Tool capability detection logic
- [@synapse/llm-info](https://www.npmjs.com/package/@synapse/llm-info) - Image support detection
