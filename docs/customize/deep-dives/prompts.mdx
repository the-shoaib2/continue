...
Below are more examples to get you started. You can also visit the Hub to [explore prompts](https://hub.synapse.dev/explore/prompts) or [create your own](https://hub.synapse.dev/new?type=block&blockType=prompts).
