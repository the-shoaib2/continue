...
After it's up and running, change `~/.synapse/config.json` to look like this:
...
[View the source](https://github.com/continuedev/synapse/blob/main/core/llm/llms/LlamaCpp.ts)
