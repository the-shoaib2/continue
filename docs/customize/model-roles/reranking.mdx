...
<Tabs>
  <Tab title="Hub">
  [Voyage Rerank 2 Block](https://hub.synapse.dev/voyageai/rerank-2)
  </Tab>
  <Tab title="YAML">
...
<Tabs>
  ...
  {/* <Tab title="Hub">
  [Cohere Reranker English v3](https://hub.synapse.dev/)
  </Tab> */}
  <Tab title="YAML">
  ```yaml title="config.yaml"
  models:
...
<Tabs>
  {/* HUB_TODO block doesn't exist */}
  {/* <Tab title="Hub">
  [GPT-4o LLM Reranker Block](https://hub.synapse.dev/)
  </Tab> */}
  <Tab title="YAML">
  ```yaml title="config.yaml"
  models:
...
<Tabs>
  {/* HUB_TODO */}
  {/* <Tab title="Hub">
  [HuggingFace TEI Reranker block](https://hub.synapse.dev/)
  </Tab> */}
    <Tab title="YAML">
    ```yaml title="config.yaml"
    models:
