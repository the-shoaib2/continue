...
export function HistoryTableRow({
  ...
  return (
    <tr
      ...
      className="border-border relative mb-2 box-border flex w-full cursor-pointer overflow-hidden rounded border border-solid p-3"
      onClick={async () => {
    ...
    >
      ...
      {hovered && !editing && (
        <td className="bg-badge absolute right-2 top-1/2 ml-auto flex -translate-y-1/2 transform items-center gap-x-1 rounded px-2 py-1 shadow-md">
