  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row items-center gap-1">
        ...
        <div
          className={`border-vsc-input-border bg-vsc-input-background relative flex items-center rounded border border-solid`}
        ...
        >
          <div
            className={`absolute left-1/4 transform rounded border-[0.2px] border-solid transition-all ${isToggled ? "translate-x-1/2 brightness-150" : "-translate-x-1/2 brightness-75"}`}
            style={{
